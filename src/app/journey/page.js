...
const JourneyMap = () => {
    ...
    return (
        <main>
            ...
            <section className='flex min-h-screen flex-col items-center font-poppins p-10 text-black' >
            ...
            <section className='flex min-h-screen flex-col items-center font-poppins p-10 text-black' style={{ backgroundColor: '#FFFFFF' }}>
