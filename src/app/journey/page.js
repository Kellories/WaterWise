    ...
    return (
        <Parallax ref={parallax} pages = {8} style = {{backgroundColor:'black'}}>
            ...
            <ParallaxLayer offset={1} speed = {1} factor = {3}>
                <main className='flex min-h-screen flex-col items-center font-poppins p-10 text-black' style = {{backgroundColor:"#95C983"}}>
...
It claims to be a solution for managing household water usage and even has Incentives to be won. </p>
            ...
            <main className='flex min-h-screen flex-col items-center font-poppins p-10 text-black' style = {{backgroundColor:"#E4A4E5"}}>
...
It also awards vouchers to users who manage to maintain a low usage. She decides to install the app.</p>
            ...
            <main className='flex min-h-screen flex-col items-center font-poppins p-10 text-black' style = {{backgroundColor:"#73BDD4"}}>
            ...
            <main className='flex min-h-screen flex-col items-center font-poppins p-10 text-black' style = {{backgroundColor:"#D46F6F"}}>
...
Additionally, a floor plan with how much water % that unit is using may urge users to manage water usage there better.</p>
            ...
            <main className='flex min-h-screen flex-col items-center font-poppins p-10 text-black' style = {{backgroundColor:"#E29B68"}}>
            ...
            <main className='flex min-h-screen flex-col items-center font-poppins p-10 text-black' style = {{backgroundColor:"#AA70F3"}}>
                <h1 className="text-3xl font-bold">Benefits</h1>
            ...
            <main className='flex min-h-screen flex-col items-center font-poppins p-10 text-black' style = {{backgroundColor:"#968D70"}}>
